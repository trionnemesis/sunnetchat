...
os.environ['GOOGLE_APPLICATION_CREDENTIALS_JSON'] = '{"type": "service_account", "client_email": "test@example.com"}'
...
def test_upload_skips_if_service_not_configured():
    ...
    with patch('app.gdrive_utils.logger') as mock_logger:
        ...
        mock_logger.error.assert_called_with("Google Drive service is not configured. Skipping upload.")
