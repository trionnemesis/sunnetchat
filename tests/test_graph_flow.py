...
class TestLegacyCompatibility:
    ...
    def test_agent_local_path(self, mock_upload, mock_tavily, mock_ollama,
                              mock_chroma, mock_http_client, mock_embeddings):
        ...
        with patch.object(graph._agent, 'llm_json', mock_json_llm), \
             patch.object(graph._agent, 'llm_text', mock_text_llm), \
    ...
    @patch('app.core_agent.TavilySearchResults')
    @patch('app.core_agent.upload_qa_to_drive')
    def test_agent_web_search_path(self, mock_upload, mock_tavily, mock_ollama,
                                   mock_chroma, mock_http_client, mock_embeddings):
        ...
        with patch.object(graph._agent, 'llm_json', mock_json_llm), \
             patch.object(graph._agent, 'llm_text', mock_text_llm), \
             patch.object(graph._agent, 'retriever', mock_retriever), \
             patch.object(graph._agent, 'web_search_tool', mock_web_search):
