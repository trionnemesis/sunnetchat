...
class TestCoreAgent:
    ...
    def mock_agent(self, mock_tavily, mock_ollama, mock_chroma, 
                   mock_http_client, mock_embeddings, mock_config):
    ...
    async def test_full_process_question_flow(self, mock_save, mock_generate, 
                                              mock_grade, mock_retrieve, mock_agent):
