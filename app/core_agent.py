...
class CoreAgent:
    ...
    async def _retry_with_backoff(self, func, *args, **kwargs):
        ...
        raise AgentError(f"Max retries exceeded: {last_error}", "MAX_RETRIES", self.config.MAX_RETRIES)
    ...
    async def web_search(self, state: GraphState) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "source": "web_search",
                "status": TaskStatus.RUNNING,
                "progress": {"step": "web_search_completed", "results_count": len(search_results)}
            }
    ...
    async def generate_answer(self, state: GraphState) -> Dict[str, Any]:
        ...
        try:
            ...
            fallback_message = ("抱歉，我在處理您的問題時遇到了錯誤。" if self.config.LANGUAGE == "zh-TW" 
    ...
    async def save_knowledge(self, state: GraphState) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "progress": {"step": "knowledge_saved", "saved": source == "web_search"}
            }
        ...
        try:
            ...
            return {
                **initial_state,
                ...
                "generation": ("處理您的問題時發生錯誤。" if self.config.LANGUAGE == "zh-TW" 
